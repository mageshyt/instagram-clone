...
const Modal = () => {
  ...
  return (
    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div
          className="pb-60 sm:-pb-40 flex items-end justify-center
              ...
              <div>
                ...
                <div className="mt-5 center  sm:mt-6">
                  <button
                   ...
                   focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:bg-gray-300 disabled:text-not-allowed hover:disbaled:bg-gray-300 hover:disbaled:bg-gray-300
                   "
                  >
